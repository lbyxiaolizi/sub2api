...
// ValidateToolCallArguments rejects truncated JSON before completed tool items
// can enter client history. Valid calls remain usable when the response itself
// reaches the output limit; finalization reports the response as incomplete.
