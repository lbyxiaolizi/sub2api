export default {
    ...
    proxyPools: {
      title: '代理池',
      description: '代理池管理：健康检测、故障转移与自动重绑',
      searchPools: '搜索池名称或描述...',
      allStatus: '全部状态',
      createPool: '创建代理池',
      poolName: '池名称',
      poolNamePlaceholder: '例如：主力池 / 备用池',
      descriptionLabel: '描述',
      descriptionPlaceholder: '可选，池用途说明',
      healthInterval: '探测间隔',
      ...
      autoRebindOn: '开启',
      autoRebindOff: '关闭',
      autoRebindLabel: '自动把账号从不健康代理改投到池内健康代理',
      status: '状态',
      statusActive: '启用',
      statusDisabled: '停用',
      health: '健康度',
      healthyProxies: '健康代理数',
      unhealthyProxies: '不健康代理数',
      unknownProxies: '未探测代理数',
      boundAccounts: '绑定账号',
      unassignedAccounts: '其中 {count} 个账号待分配代理',
      unassignedAccountBadge: '{count} 待分配',
      updatedAt: '更新时间',
      detail: '详情',
      noPools: '暂无代理池',
      noPoolsHint: '创建代理池并将代理加入池内，系统将自动进行健康检测与故障转移',
      editPool: '编辑代理池',
      deletePool: '删除代理池',
      deletePoolConfirm: '确定要删除代理池 {name} 吗？池内代理将保留但不再参与池调度。',
      poolDetail: '代理池：{name}',
      totalProxies: '代理总数',
      poolProxies: '池内代理',
      rebindNow: '立即重绑',
      assignProxy: '添加代理',
      noPoolProxies: '池内暂无代理，点击「添加代理」加入',
      proxyName: '代理名称',
      failures: '连续失败',
      lastChecked: '上次探测',
      latency: '延迟',
      boundToPool: '已绑定：{name}',
      reassignProxyTitle: '重新绑定代理',
      reassignProxyConfirm: '将 {count} 个代理移入「{name}」？这些代理会离开原代理池。',
      reassignProxyAction: '确认重绑',
      removeFromPool: '移出池',
      removeProxyConfirm: '确定将代理 {name} 移出该池吗？',
      assignedAccounts: '池绑定账号',
      noAssignedAccounts: '该池暂无绑定账号',
      accountName: '账号名称',
      platform: '平台',
      accountType: '账号类型',
      currentProxy: '当前代理',
      directConnection: '直连 / 待分配',
      rebindLogs: '重绑日志',
      noRebindLogs: '暂无重绑记录',
      time: '时间',
      fromProxy: '原代理',
      ...
      reasonUnhealthy: '不健康',
      reasonManual: '手动',
      searchProxies: '搜索代理名称或地址...',
      selectedCount: '已选 {count} 个',
      noAssignableProxies: '所有代理都已在池内',
      assignConfirm: '确认加入',
      nameRequired: '池名称不能为空',
      createSuccess: '代理池创建成功',
      updateSuccess: '代理池更新成功',
      proxyPool: '代理池',
      noPool: '不绑定代理池',
      poolAssignmentHint: '绑定代理池后由池服务自动分配池内健康代理；选择具体代理将解除池绑定',
      saveFailed: '保存代理池失败',
      deleteSuccess: '代理池已删除',
      deleteFailed: '删除代理池失败',
      assignSuccess: '已加入 {count} 个代理',
      assignFailed: '加入代理失败',
      removeSuccess: '代理已移出池',
      removeFailed: '移出代理失败',
      rebindDone: '重绑完成，{count} 个账号已切换',
      rebindPartial: '已切换 {count} 个账号，但 {failed} 个代理的重绑失败',
      rebindFailed: '重绑失败',
      failedToLoad: '加载代理池失败',
      failedToLoadProxies: '加载池内代理失败',
      failedToLoadAccounts: '加载池绑定账号失败',
      failedToLoadLogs: '加载重绑日志失败'
    },
