    ...
    <div v-if="rows.length > 0" class="mb-2 space-y-2">
      ...
      >
        ...
        <Select
         ...
         :options="[{ value: 'chat_completions', label: t('admin.accounts.cnProviders.apiProtocol.chatCompletions') }, { value: 'responses', label: t('admin.accounts.cnProviders.apiProtocol.responses') }, { value: 'anthropic', label: t('admin.accounts.cnProviders.apiProtocol.anthropic') }]" />
        <button
          type="button"
