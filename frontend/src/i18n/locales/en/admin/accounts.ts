export default {
    accounts: {
      ...
      disableAutoTempUnschedulable: 'Never Temp Unschedulable',
      disableAutoTempUnschedulableDesc: 'When enabled, errors never mark this account as temporarily unschedulable, and any active mark is cleared',
