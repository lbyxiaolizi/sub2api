...
type Account struct {
	...
	// Proxy pool id; pool service maintains proxy assignment.
...
// was not loaded in eager-loading, or loaded but was not found.
func (e AccountEdges) PoolOrErr() (*ProxyPool, error) {
	if e.Pool != nil {
		return e.Pool, nil
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldID, account.FieldProxyID, account.FieldPoolID, account.FieldProxyFallbackOriginID, account.FieldConcurrency, account.FieldLoadFactor, account.FieldPriority, account.FieldParentAccountID:
...
// QueryPool queries the "pool" edge of the Account entity.
func (_m *Account) QueryPool() *ProxyPoolQuery {
	return NewAccountClient(_m.config).QueryPool(_m)
}
