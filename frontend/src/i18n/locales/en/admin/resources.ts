export default {
    ...
    proxyPools: {
      title: 'Proxy Pools',
      description: 'Proxy pool management: health checks, failover and auto rebind',
      searchPools: 'Search pool name or description...',
      allStatus: 'All Status',
      createPool: 'Create Pool',
      poolName: 'Pool Name',
      poolNamePlaceholder: 'e.g. Primary / Backup',
      descriptionLabel: 'Description',
      descriptionPlaceholder: 'Optional pool description',
      healthInterval: 'Probe Interval',
      failureThreshold: 'Failure Threshold',
      seconds: 'sec',
      autoRebind: 'Auto Rebind',
      autoRebindOn: 'On',
      autoRebindOff: 'Off',
      autoRebindLabel: 'Automatically rebind accounts from unhealthy proxies to a healthy one in the pool',
      status: 'Status',
      statusActive: 'Active',
      ...
      noPoolsHint: 'Create a pool and add proxies to enable automatic health checks and failover',
      editPool: 'Edit Pool',
      deletePool: 'Delete Pool',
      deletePoolConfirm: 'Delete proxy pool {name}? Proxies inside will be kept but stop participating in pool scheduling.',
      poolDetail: 'Proxy Pool: {name}',
      totalProxies: 'Total Proxies',
      poolProxies: 'Pool Proxies',
      rebindNow: 'Rebind Now',
      assignProxy: 'Add Proxies',
      noPoolProxies: 'No proxies in this pool yet. Click "Add Proxies" to join.',
      proxyName: 'Proxy',
      failures: 'Failures',
      ...
      reasonManual: 'Manual',
      searchProxies: 'Search proxy name or address...',
      selectedCount: '{count} selected',
      noAssignableProxies: 'All proxies are already in this pool',
      assignConfirm: 'Assign',
      nameRequired: 'Pool name is required',
      createSuccess: 'Proxy pool created',
      updateSuccess: 'Proxy pool updated',
      proxyPool: 'Proxy Pool',
      noPool: 'No pool binding',
      poolAssignmentHint: 'When bound to a pool, the pool service auto-assigns a healthy in-pool proxy; picking a specific proxy clears the pool binding',
      saveFailed: 'Failed to save proxy pool',
      deleteSuccess: 'Proxy pool deleted',
      deleteFailed: 'Failed to delete proxy pool',
      assignSuccess: '{count} proxies assigned',
      assignFailed: 'Failed to assign proxies',
